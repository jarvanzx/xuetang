          ...
          <button open-type="contact" class="contact-btn">
			...
			<view class="swiper-wrap">
				<swiper :indicator-dots="false" indicator-color="rgba(255,255,255,0.5)" indicator-active-color="#fff"
					...
					<swiper-item v-for="item in bannerList" :key="item.id">
						<image class="swiper-item" :src="item.thumb_image" mode="aspectFill"
							@click="handleBanner(item)"></image>
					</swiper-item>
					<!-- 	<swiper-item>
			...
			<view class="index-audio-wrap">
				<view class="audio-box">
					<view v-for="item in teacherAudio" :key="item.id" class="index-audio" @click="toAudioDetail(item)">
						...
						<image :src="item.course_file[0].poster_image" style="border:2rpx solid #8840FF" class="audio-img"
							mode="aspectFill" v-if="item.course_file.length>0">
						</image>
						
						<image :src="item.thumb_image" style="border:2rpx solid #8840FF" class="audio-img"
							mode="aspectFill" v-else>
						</image>
						
						<view class="audio-left" v-if="item.course_file.length>0">
							<view class="audio-title">
								<view class="ellipsis">{{item.course_file[0].name}}</view>
								<image src="https://jzxt.qifudaren.net/static/audio/playing.gif" class="audio-status"
									mode="aspectFill">
								</image>
						...
						<image src="https://jzxt.qifudaren.net/static/index/audio-play.png" class="audio-paly"
							mode="aspectFill">
						</image>
					</view>
				</view>
			...
			<view class="banner-wrap">
				<view class="banner-item" @click="toUrl('/pages/user/vip')">
					<image src="https://jzxt.qifudaren.net/static/index/nav-vip.png" class="banner-item-img" mode="">
					</image>
				</view>
				<view class="banner-item" @click="toUrl('/pages/user/rank')">
					<image src="https://jzxt.qifudaren.net/static/index/nav-rank.png" class="banner-item-img" mode="">
					</image>
				</view>
				<view class="banner-item" @click="toUrl('/pages/user/lottery')">
					<image src="https://jzxt.qifudaren.net/static/index/nav-lottery.png" class="banner-item-img"
						mode=""></image>
				</view>
			</view>
			...
			<view class="index-nav">
				<view class="grid  text-center col-5">
					<view class="nav-item" v-for="item in navList" :key="item.name" @click="toUrl(item.path)">
						<image :src="`https://jzxt.qifudaren.net/static/index/${item.url}.png`" class="nav-item-img"
							mode="">
						</image>
					...
					<view class="nav-item">
						...
						<image :src="`https://jzxt.qifudaren.net/static/index/nav-kehu.png`" class="nav-item-img"
							mode=""></image>
