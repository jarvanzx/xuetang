  ...
  <view class="page-course-detail">
    <view class="page-main-content">
      ...
      <!-- #endif -->
        ...
        <!-- #endif -->
          <image src="https://jzxt.qifudaren.net/static/common/back-black.png" class="back-img" mode="" @click="back">
          </image>
          <view class="vip-nav">
        ...
        <scroll-view :style="{width: '100%', height: `calc(${safeHeight}px - 84px)`}" scroll-y
          ...
          <view class="course-cover-wrap" id="goods">
            ...
            <video :src="chapters[currCourseIndex]['file']" class="course-video-wrap"
              :poster="chapters[currCourseIndex]['poster_image']" :direction="-90" controls object-fit="contain"
              @timeupdate="onTimeUpdate" @ended="onEnded" @fullscreenchange="playerFullScreen" id="videoRef"></video>
            <cover-view @click="showSpeed=true"
              ...
              <cover-image src="https://jzxt.qifudaren.net/static/audio/icon-speed-1.png" class="icon-48" mode="">
              </cover-image>
          ...
          <view class="bg-white course-detial-info">
            ...
            <view class="text-gray margin-top-sm flex align-center">
              <view class="flex align-center margin-right-xl">
                <image src="https://jzxt.qifudaren.net/static/course/icon-keshi.png" class="icon-32 margin-right-8"
                  mode="">
                </image>
                {{detailData.class_hour}}课时
              </view>
              <view class="flex align-center">
                <image src="https://jzxt.qifudaren.net/static/course/icon-bofang-2.png" class="icon-32 margin-right-8"
                  mode=""></image>
            ...
            <view class="grid col-5 text-gray">
              ...
              <view class="flex align-center justify-center info-tab-item" @click="handleCmt">
                <image src="https://jzxt.qifudaren.net/static/course/icon-pinglun.png" class="icon-48" mode=""></image>
                <view>评论</view>
              </view>

              <view class="flex align-center justify-center info-tab-item" @click="showReward = true">
                <image src="https://jzxt.qifudaren.net/static/course/icon-dashang.png" class="icon-48" mode=""></image>
                <view>打赏</view>
              </view>
              <view class="flex align-center justify-center info-tab-item" @click="toGoods">
                <image src="https://jzxt.qifudaren.net/static/course/icon-recommend.png" class="icon-48" mode="">
                </image>
                <view>推荐产品</view>
              </view>
              <view class="flex align-center justify-center info-tab-item" @click="toShowWx">
                <image src="https://jzxt.qifudaren.net/static/course/icon-weixin.png" class="icon-48" mode=""></image>
                <view>联系助教</view>
              </view>
            </view>
          </view>
          ...
          <view class="course-detail-card bg-white" id="detail">
            <view class="course-detail-card-nav">
              <view class="course-detail-card-nav-item" :class="{'course-detail-card-nav-item-active': cardNav === 1}"
                @click="changeCardNav(1)">课程介绍</view>
              <view class="course-detail-card-nav-item" :class="{'course-detail-card-nav-item-active': cardNav === 2}"
            ...
            <view class="course-detail-card-content course-catalogue-wrap" v-if="cardNav === 2">
              ...
              <view class="course-catalogue-list">
                <view class="course-catalogue-item flex align-center justify-between" v-for="(item,index) in chapters"
                  :key="item.id" @click="changeCourse(index)">
                  <view>
                  ...
                  <image v-if="index == currCourseIndex"
                    src="https://jzxt.qifudaren.net/static/course/icon-course-playing.png" class="icon-48"
                    mode="aspectFill">
                  </image>
                  <image v-else src="https://jzxt.qifudaren.net/static/course/icon-course-play.png" class="icon-48"
                    mode="aspectFill">
                  </image>
                </view>
              </view>
                  ...
                  <view class="flex align-center justify-between">
                    ...
                    <view class="flex align-center">
                      <image src="https://jzxt.qifudaren.net/static/course/icon-pinglun-2.png"
                        class="icon-36 margin-right" mode="aspectFill" @click="replyCmt(item.id)"></image>
                      <view class="flex align-center">
    ...
    methods: {
      ...
      async handleCollect() {
        let res = await this.$Api.postChapterCollect({
          ...
          course_id: this.courseId,
          course_file_id: this.chapters[this.currCourseIndex].id
        })
